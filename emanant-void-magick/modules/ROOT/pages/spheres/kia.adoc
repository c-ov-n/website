...
.Structure of twelve sphere tree of Kia
image::diagrams/12-tree.svg[width=100%]

== Flower of Emanation

This figure summarizes the process of manifestation.
...
2 → 3 → 5 → 8 → 13.
The Fibonacci sequence is known to occur in many natural systems including growth of flower petals,
