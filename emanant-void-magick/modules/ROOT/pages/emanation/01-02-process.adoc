...
Each emanation leaves space for the next emanation.
...
The glyph of hĕzh-ēsh and its pronunciation is produced in the same manner as explained above for nĕsh-hĭn.
