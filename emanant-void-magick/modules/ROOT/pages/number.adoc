...
The pronunciations are paired in a cycle where the initial and final sounds
...
and the voiced consonant is is assigned as the initial sound of the preceding composite number.
